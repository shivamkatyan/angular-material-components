  ...
  [251],
  {
    4251: (Se, ut, l) => {
        ...
        class a extends _.en {
          ...
          _initializeFocusTrap() {
            ((this._focusTrap = this._focusTrapFactory.create(
              ...
              this._document &&
                (this._elementFocusedBeforeDialogWasOpened = (0, rt.ht)()));
          }
        ...
        yt = (() => {
          class a {
            ...
            _attachContainer(e, i, n) {
              ...
              const s =
                  n.injector ||
                  (null === (r = n.viewContainerRef) || void 0 === r
                    ? void 0
                    : r.injector),
                c = [
              ...
              n.container
                ? "function" == typeof n.container
                  ? (g = n.container)
                  : ((g = n.container.type),
                    c.push(...n.container.providers(n)))
                : (g = bt);
              const m = new _.C5(
                g,
                n.viewContainerRef,
            ...
            _createInjector(e, i, n, r) {
              ...
              const c =
                  e.injector ||
                  (null === (s = e.viewContainerRef) || void 0 === s
                    ? void 0
                    : s.injector),
                g = [
      ...
      let Jt = (() => {
        class a extends bt {
          constructor(e, i, n, r, s, c, g, m) {
            (super(e, i, n, r, s, c, g, m),
              (this._animationStateChanged = new t.vpe()));
          }
          _captureInitialFocus() {
          ...
          constructor(e, i, n, r, s, c, g, m, F) {
            ...
            (super(e, i, n, r, s, c, g, F),
              ...
              (this._openAnimationDuration = this._animationsEnabled
                ? null !== (L = Tt(this._config.enterAnimationDuration)) &&
                  void 0 !== L
                  ? L
                  : 150
                : 0),
              (this._closeAnimationDuration = this._animationsEnabled
                ? null !== (mt = Tt(this._config.exitAnimationDuration)) &&
                  void 0 !== mt
                  ? mt
                  : ft_DIALOG_ANIMATION_CLOSE_TIME_MS
                : 0),
          ...
          (a.ɵcmp = t.Xpm({
            ...
            hostBindings: function (e, i) {
              2 & e &&
                ...
                t.uIk("aria-modal", i._config.ariaModal)(
                  "role",
                  i._config.role,
                )(
                  "aria-labelledby",
          ...
          ((this._ref = o),
            ...
            (0, B.T)(
              ...
              this.keydownEvents().pipe(
                (0, G.h)(
                  (n) =>
                    n.keyCode === M.hY && !this.disableClose && !(0, M.Vb)(n),
                ),
              ),
            ).subscribe((n) => {
              this.disableClose ||
      ...
      let oe = 0,
          ...
          class a {
            ...
            open(e, i) {
              ...
              (((i = { ...(this._defaultOptions || new at()), ...i }).id =
                ...
                (i.scrollStrategy =
                  i.scrollStrategy || this._scrollStrategy()));
              const r = this._dialog.open(e, {
                ...
                providers: (s, c, g) => {
                  ...
                  return (
                    ...
                    n.updatePosition(
                      null === (m = i) || void 0 === m ? void 0 : m.position,
                    ),
                    [
        ...
        ae = (() => {
          ...
          return (
            ...
            (a.ɵinj = t.cJS({
              providers: [Dt, ee],
              imports: [zt, p.U8, _.eL, it.BQ, it.BQ],
            })),
            a
          );
        })();
          ...
          template: function (o, e) {
            (1 & o &&
              ...
              2 & o &&
                ...
                t.Udp(
                  "background-color",
                  (null == e.color ? null : e.color.rgba) || "transparent",
                ),
                t.xp6(1),
                t.Q6J("color", e.theme),
                t.xp6(6),
      ...
      function me(a, o) {
        ...
        if (2 & a) {
          ...
          (t.Udp("background-color", e),
            t.Q6J("ngClass", t.VKq(4, Nt, i.selectedColor === e))(
              "disableRipple",
              !0,
            ));
        }
        ...
        (z.ɵcmp = t.Xpm({
          ...
          template: function (o, e) {
            (1 & o &&
              ...
              2 & o &&
                (t.xp6(1),
                t.Q6J("ngForOf", e.colors1),
                t.xp6(2),
                t.Q6J("ngForOf", e.colors2)));
          },
        ...
        (I.ɵcmp = t.Xpm({
          ...
          template: function (o, e) {
            (1 & o &&
              ...
              t.qZA()),
              2 & o &&
                (t.Q6J("color", e.color)("theme", e.theme),
                t.xp6(1),
                t.Q6J("color", e.color)));
          },
          dependencies: [H, z],
      ...
      class j {
        ...
        set disabled(o) {
          const e = (0, U.Ig)(o);
          e !== this._disabled &&
            ((this._disabled = e), this._disabledChange.next(e));
        }
        get touchUi() {
        ...
        get color() {
          return (
            this._color ||
            (this._pickerInput ? this._pickerInput.getThemePalette() : void 0)
          );
        }
        set color(o) {
          this._color = o;
        ...
        ngOnDestroy() {
          (this.close(),
            ...
            this._popupRef &&
              (this._popupRef.dispose(), (this._popupComponentRef = null)));
        }
        select(o) {
          let e = this._selected;
          ((this._selected = o),
            this._adapter.sameColor(e, this._selected) ||
              this._selectedChanged.next(o));
        }
        registerInput(o) {
          if (this._pickerInput)
            throw Error(
              "A ColorPicker can only be associated with a single input.",
            );
          ((this._pickerInput = o),
        ...
        open() {
          if (!this._opened && !this.disabled) {
            if (!this._pickerInput)
              throw Error(
                "Attempted to open an ColorPicker with no associated input.",
              );
            (this._document &&
              ...
              this._popupRef
                ...
                .pipe(
                  (0, G.h)(
                    (e) =>
                      e.keyCode === M.hY ||
                      (this._pickerInput && e.altKey && e.keyCode === M.LH),
                  ),
                ),
            ).subscribe((e) => {
        ...
        close() {
          ...
          (this._popupRef &&
            ...
            this._dialogRef &&
              (this._dialogRef.close(), (this._dialogRef = null)),
        ...
        _setColor() {
          ...
          (this._popupComponentRef &&
            (this._popupComponentRef.instance.color = o),
      ...
      class A {
              ...
              (e) => {
                ((this.value = e),
                  ...
                  this.colorInput.emit(
                    new nt(this, this._elementRef.nativeElement),
                  ),
        ...
        set disabled(o) {
          ...
          (this._disabled !== e &&
            ((this._disabled = e), this._disabledChange.emit(e)),
            e && i.blur && i.blur());
        }
        get value() {
          return this._value;
            ...
            (1 & o &&
              ...
              2 & o &&
                ...
                t.uIk("aria-haspopup", e._picker ? "dialog" : null)(
                  "aria-owns",
                  ((null == e._picker ? null : e._picker.opened) &&
                    e._picker.id) ||
                    null,
                )));
          },
      ...
      function ye(a, o) {
        if (
          (1 & a && (t.TgZ(0, "mat-icon"), t._uU(1, " palette "), t.qZA()),
          2 & a)
        ) {
          const e = t.oxw();
          t.Udp(
            "color",
            null == e.picker || null == e.picker._selected
              ? null
              : e.picker._selected.rgba,
          );
        }
      }
      ...
      class J {
        ...
        get disabled() {
          if (null == this._disabled && this.picker)
        ...
        open(o) {
          this.picker &&
            !this.disabled &&
            (this.picker.open(), o.stopPropagation());
        }
        _watchStateChanges() {
          const o = this.picker ? this.picker._disabledChange : (0, tt.of)(),
            ...
            i = this.picker
              ...
              : (0, tt.of)();
          (this._stateChanges.unsubscribe(),
            (this._stateChanges = (0, B.T)(o, e, i).subscribe(() =>
            ...
            (1 & o &&
              ...
              2 & o &&
                ...
                t.ekj(
                  ...
                  e.picker && e.picker.opened,
                )("mat-accent", e.picker && "accent" === e.picker.color)(
                  "mat-warn",
                  e.picker && "warn" === e.picker.color,
                )));
          },
          inputs: {
            picker: ["for", "picker"],
      ...
      function Oe(a, o) {
        if (
          (1 & a && (t.TgZ(0, "mat-radio-button", 32), t._uU(1), t.qZA()),
          2 & a)
        ) {
          const e = o.$implicit;
      ...
      class Q {
        constructor() {
          ((this.disabled = !1),
            ...
            (this.code1 = "npm install --save @katyan/color-picker"),
            (this.code2 =
      ...
      ((Q.ɵfac = function (o) {
        ...
        (Q.ɵcmp = t.Xpm({
          ...
          consts: [
            ...
            [
              "href",
              "https://www.npmjs.com/package/@katyan/color-picker",
              "target",
              "_blank",
            ],
            [
              "src",
              "https://badge.fury.io/js/%40angular-material-components%2Fcolor-picker.svg",
            ],
            ["ngxMatHighlight", ""],
          ...
          template: function (o, e) {
            if (
              (1 & o &&
                ...
                t.qZA(),
                t.TgZ(6, "h1"),
                t._uU(7, "API reference for @katyan/color-picker"),
                t.qZA(),
                t.TgZ(8, "h2"),
                ...
                t._uU(89),
                t.qZA()()(),
                t.TgZ(90, "mat-tab", 11)(91, "mat-card", 12)(
                  92,
                  "mat-card-content",
                )(93, "div", 13),
                t._uU(94),
                ...
                t._uU(96),
                t.qZA()()(),
                t.TgZ(97, "mat-card", 14)(98, "mat-card-content")(
                  99,
                  "mat-form-field",
                ),
                ...
                t._uU(133),
                t.qZA()(),
                t.TgZ(134, "mat-card", 14)(135, "mat-card-content")(
                  136,
                  "mat-form-field",
                ),
                t._UZ(137, "input", 15),
              ...
              (t.Q6J("mat-stretch-tabs", !1),
                ...
                t.Udp(
                  "background-color",
                  null == e.colorCtr.value ? null : e.colorCtr.value.rgba,
                ),
                t.xp6(1),
                t.hij(
                  "HEX: ",
                  null == e.colorCtr.value ? null : e.colorCtr.value.hex,
                  "",
                ),
                t.xp6(2),
                t.hij(
                ...
                t.xp6(4),
                t.Q6J("ngxMatColorPicker", i)("formControl", e.colorCtr)(
                  "disabled",
                  e.disabled,
                ),
                t.xp6(1),
                ...
                t.Oqu(e.code7),
                t.xp6(4),
                t.Q6J("ngxMatColorPicker", n)("formControl", e.colorCtr)(
                  "disabled",
                  e.disabled,
                ),
                t.xp6(1),
      ...
      ((P.ɵfac = function (o) {
        ...
        (P.ɵinj = t.cJS({
          providers: [
            { provide: Ft, useValue: { display: { colorInput: "hex8" } } },
          ],
          imports: [
            f.ez,
            Ut.Bz.forChild(Re),
