      ...
      class p {
        constructor() {
          ((this.disabled = !1),
            ...
            (this.code1 = "npm install --save @katyan/datetime-picker"),
            (this.code3 =
            ...
            (this.code4 = "npm install --save  @katyan/moment-adapter"),
            (this.code5 =
      ...
      ((p.ɵfac = function (o) {
        ...
        (p.ɵcmp = e.Xpm({
          ...
          consts: [
            ...
            [
              "href",
              "https://www.npmjs.com/package/@katyan/datetime-picker",
              "target",
              "_blank",
            ],
            [
            ...
            ["href", "https://www.npmjs.com/package/@katyan/moment-adapter"],
          ...
          template: function (o, t) {
            if (
              (1 & o &&
                ...
                e.qZA(),
                e.TgZ(6, "h1"),
                e._uU(7, "API reference for @katyan/datetime-picker"),
                e.qZA(),
                e.TgZ(8, "h2"),
                ...
                e.qZA(),
                e.TgZ(198, "td"),
                e._uU(199, "@katyan/datetime-picker"),
                e.qZA(),
                e.TgZ(200, "td")(201, "a", 9),
                e._uU(202, "@katyan/moment-adapter"),
                e.qZA()()()()(),
                e._uU(203, " To use "),
                e.TgZ(204, "strong"),
